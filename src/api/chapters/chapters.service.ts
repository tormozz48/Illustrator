...
import {
  Chapter,
  ChapterStatus,
} from "../../common/database/models/chapter.model";
...
export class ChaptersService {
  ...
  async enqueueImageGeneration(
    ...
    this.logger.log(
      `✅ [DEBUG] Image generation job ${job.id} enqueued for book ${bookId} chapter ${chapterNum}, ${sceneIds.length} scenes, ${variantCount} variants each`
    );
