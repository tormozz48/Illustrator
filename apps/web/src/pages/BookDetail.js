...
export default function BookDetail() {
  ...
  if (error) {
    return _jsxs('main', {
      ...
      children: [
        _jsx('p', { className: styles.error, children: error }),
        _jsx(Link, { to: '/books', children: '\u2190 Back to library' }),
      ],
    });
  }
  if (!book) {
    return _jsx('main', {
      className: styles.main,
      children: _jsx('p', { className: styles.muted, children: 'Loading\u2026' }),
    });
  }
  ...
  return _jsxs('main', {
    className: styles.main,
    children: [
      _jsx(Link, { to: '/books', className: styles.back, children: '\u2190 Library' }),
      _jsx('h1', { className: styles.title, children: book.title }),
      book.author && _jsxs('p', { className: styles.author, children: ['by ', book.author] }),
      book.status === 'error'
        ? _jsxs('div', {
            className: styles.errorBox,
            children: [
              _jsx('strong', { children: 'Processing failed' }),
              book.error_msg && _jsx('p', { children: book.error_msg }),
            ],
          })
        : _jsx('ol', {
              ...
              return _jsxs(
                'li',
                {
                  ...
                  children: [
                    ...
                    _jsx('span', { children: step.label }),
                    active && _jsx('span', { className: styles.spinner, 'aria-hidden': 'true' }),
                  ],
                },
                step.key
              );
