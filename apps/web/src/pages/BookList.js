  ...
  return _jsxs('main', {
    ...
    children: [
      _jsxs('header', {
        ...
        children: [
          _jsx('h1', { children: 'Your Library' }),
          _jsx(Link, { to: '/', className: styles.uploadBtn, children: '+ Upload book' }),
        ],
      }),
      loading && _jsx('p', { className: styles.muted, children: 'Loading\u2026' }),
      error && _jsx('p', { className: styles.error, children: error }),
      !loading &&
        books.length === 0 &&
        _jsxs('p', {
          className: styles.empty,
          children: ['No books yet. ', _jsx(Link, { to: '/', children: 'Upload one!' })],
        }),
      _jsx('ul', {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('div', {
                      ...
                      children:
                        book.status === 'done'
                          ? _jsx(Link, { to: `/books/${book.id}/read`, children: book.title })
                          : _jsx('span', { children: book.title }),
                    }),
                    book.author &&
                      _jsxs('div', {
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx(StatusBadge, { status: book.status }),
                        book.error_msg &&
                          _jsxs('span', {
                            className: styles.errorMsg,
                            title: book.error_msg,
                            children: ['\u26A0 ', book.error_msg.slice(0, 80)],
                          }),
                      ],
                    }),
                  ],
